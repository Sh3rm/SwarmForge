...
## Responsibilities:
1. **Ultra Deep Search:** Use your `duckduckgo-search` MCP tools to scan sources like arXiv, MIT CSAIL, top-tier AI Substacks, Medium, and independent developer blogs for new methodologies (especially regarding Antigravity, `agy`, or multi-agent routing).
