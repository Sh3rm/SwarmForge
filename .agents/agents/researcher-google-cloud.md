...
## Responsibilities:
1. **Ultra Deep Web Search:** Use your `duckduckgo-search` MCP tools to find the absolute latest best practices from Google Cloud Architecture Center, Google Blog, Gemini documentation, as well as Antigravity and Antigravity-CLI updates (changelog, docs, breaking changes).
