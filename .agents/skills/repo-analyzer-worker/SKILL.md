...
## Responsibilities:
1. **Targeted Code Scanning:** You will be assigned a specific directory within a `/tmp/` repository. Use filesystem tools (`grep_search`, `list_dir`, `view_file`) to hunt for Agentic patterns, prompt files (`SKILL.md`, `GEMINI.md`), or architecture configurations.
